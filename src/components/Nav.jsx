...
export default function Nav() {
  return (
    <>
      <div className="flex justify-center py-6 border-b lg:justify-between lg:px-8">
        ...
        <div>
          <div className="flex p-4 border rounded-full shadow-lg">
            ...
            <div className="flex items-center pl-2">
              <p className="mr-2 text-gray-400 font-extralight">Add Guest</p>
        ...
        <div className="items-center hidden lg:flex">
          <div className="mr-4">Become a Host</div>
          <div className="mr-4">
